...
let wasm;
const { log, setLogger } = require(String.raw`./snippets/wasm-js-rewriter-352b414960a32145/tracer_logger.js`);
...
module.exports.__wbg_dirname_84a7eeb45dcbdcfc = function() { return handleError(function (arg0, arg1) {
    const ret = dirname(getStringFromWasm0(arg0, arg1));
    return addHeapObject(ret);
}, arguments) };

module.exports.__wbg_readFileSync_32f00c8b2f5b7215 = function() { return handleError(function (arg0, arg1) {
...
module.exports.__wbg_log_15ee026984f9a0f5 = function() { return handleError(function (arg0, arg1) {
    const ret = log(getObject(arg0), getObject(arg1));
    return addHeapObject(ret);
}, arguments) };

module.exports.__wbg_setLogger_02607cfa3e4f2824 = function() { return handleError(function (arg0) {
